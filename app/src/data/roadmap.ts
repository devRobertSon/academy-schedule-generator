...
export const TRACK_COURSES: Course[] = [
  ...
  // 과학고 · 면접 (특화 면접 레인) — 파이널 면담 9월~10월 중순, 파이널 면접 10월 중순~11월 중순
  { id: 'sg_final_talk', name: '과학고 파이널 면담', track: '과학고', subject: '면접', type: '과학고입시',
    start: { grade: '중3', month: 9 }, end: { grade: '중3', month: 10, half: true }, schedule: [{ day: '토', start: '13:00', end: '15:00' }] },
  { id: 'sg_final_interview', name: '과학고 파이널 면접', track: '과학고', subject: '면접', type: '과학고입시',
    start: { grade: '중3', month: 10, half: true }, end: { grade: '중3', month: 11, half: true }, schedule: [{ day: '토', start: '13:00', end: '15:00' }, { day: '일', start: '13:00', end: '15:00' }] },
  // 국제고
...
export const TRACK_PLANS: Record<Track, TrackPlan> = {
  영재학교: {
    phases: [
      ...
      { name: '③ 지필평가 준비', start: ym('중2', 12), end: ym('중3', 6) },
      { name: '④ 면접 준비', start: ym('중3', 7), end: ym('중3', 7) },
      { name: '⑤ 입학 준비', start: ym('중3', 8), end: ym('중3', 11) },
    ],
    milestones: [
  ...
  전사고: {
    ...
    milestones: [{ name: '전사고 면접 평가', at: ym('중3', 12, true) }], // 12월 중순
  },
};
